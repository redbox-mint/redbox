...
class IndexData:
    def __activate__(self, context):
        print " * Running submission-rules.py..."
    ...
    def __newDoc(self):
        ...
        self.utils.add(self.index, "display_type", "submission-request")
    ...
    def __metadata(self):
        self.titleList = ["Submission Request"]
    ...
    def __workflow(self):
        ...
        try:
            ...
            wfPayload.close()
            wfMeta.set("pageTitle", "Submission Request")
        ...
        if formData is not None:
            ...
            if description:
                self.titleList = [truncate(description[0])]
        ...
        self.titleList = [truncate(description, 25)]
        self.descriptionList = [description]
